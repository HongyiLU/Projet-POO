...
public:
    ...
    LocauxProfessionnels(double mPrix, double mSurface, int mId, string mAdresse, const Client &mVendeur, double mTailleVitrine,
                         bool mPieceDeStock) : Bien(mPrix, mSurface, mId, mAdresse, mVendeur), m_TailleVitrine(mTailleVitrine),
